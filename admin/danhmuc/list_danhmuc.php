            ...
            <tbody>
              ...
              foreach ($categori_all as $value) { ?>
                ...
                <tr>
                  ...
                  <td class="btn1">
                    <a href="index.php?act=update_dm&categori_id=<?php echo $value['categori_id'] ?>">
                      <input class="btn btn-primary btn2" type="button" value="Sửa">
                    </a>
                    <a href="index.php?act=delete_dm&categori_id=<?php echo $value['categori_id'] ?>" onclick="return confirm(`Bạn muốn xóa?`)" id="delete">
